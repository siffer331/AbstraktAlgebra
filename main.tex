...
\begin{document}
	...
	\section*{Del 2 22/2}
		...
		\begin{defi}
			...
			en function. Da kaldes $\phi$ en gruppe homomorphi hvis
			...
			En isomorphi $\phi: G \too G$ mellem en gruppe $G$ og den selv kaldes for en
			automorphi på $G$.
		\end{defi}
		\subsection*{Sætninger}
		\begin{setn}
		...
		\subsection*{Vis selv}
		\begin{setn}
			For to grupper $(G,*)$ og $(H, \diamond)$, en homomorphi $\varphi: G \too H$
